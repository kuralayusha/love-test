...
import dataML from '../../../ML.json'

function ManLong() {
  const [MLquestions, setMLquestions] = useState<any>(dataML)
  ...
  function handleAnswerClick(point: number, questionId: number) {
    ...
    const questionIndex = MLquestions.questions.findIndex(
  ...
  return (
    <div>
      {showQuestions && (
        <>
          {MLquestions.questions.map((question: any) => (
            <div key={question.id}>
